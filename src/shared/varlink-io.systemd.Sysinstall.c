...
static SD_VARLINK_DEFINE_METHOD_FULL(
                ...
                SD_VARLINK_DEFINE_INPUT(summary, SD_VARLINK_BOOL, 0),
                ...
                SD_VARLINK_FIELD_COMMENT("In summary mode returns the minimal disk size required."),
                SD_VARLINK_DEFINE_OUTPUT(minimalSizeBytes, SD_VARLINK_INT, SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT("In summary mode returns the size of the selected block device."),
